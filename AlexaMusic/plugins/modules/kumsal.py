...
selam = {
    ...
    "allah": (
        "**rabbim ALLAH yaratıcım @alya_albora ** 🥰",
        "**göklerin ve yerlerin tek hâkimi Allah.cc!** 🔱",
        "** allah'u akbar!** 🇹🇷",
        "**Damarımdaki asil kan oldukça kimseye boyun eğmem!** 🩸",
        "**Müslüman ölür ama asla teslim olmaz!** 💀",
        "**Bir hilal uğruna nice güneşler batar!** 🌙",
        "**bizi yaratan Allah almasını da iyi bilir!** 🛡️",
        "**ben vatanımın tek oğluyum!** 🇸🇦",
        "**İman varsa imkan vardır!** ✊",
    ),
    "sahip": (
        "@the_alya_albora **Sana sesleniyorlarr**",
        "**Adamdır** 🌹",
        "**Adamımmmm**",
    ...
    "albora": (
        "**o bir bot geliştiricisi @the_alya_albora**",
        "**Ülkücü sahibim gel @the_alya_albora**",
        "**🩵 Geliştirici** Alya albora ",
        "**Sahibim @alya_albora 🇹🇷**",
        "**Alya albora sahibim **",	
    ),
    "nasılsın": (
